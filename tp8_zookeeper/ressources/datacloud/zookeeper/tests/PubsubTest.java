...
public class PubsubTest extends ZookeeperTest {
	...
	public void test() throws Exception {
		...
		for(Subscriber s : Arrays.asList(s1,s2,s3,s4,s5,s6)) {
			System.out.println(s1.received("topic2")+" ============ ");
...
/*
 * le publisher ecrit pluein de fois 
 * 
 * mais le probleme c'est que le Subscriber lit que le dernier element ecrit
 * 
 * 
 * faire un mecanisme d'attente ??? 
 * 
 * faire une recuperation de chaque valeur grace a la version ???
 * 
 * 
 * 
 * 
